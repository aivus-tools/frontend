export const RU_LOCALES = {
  ...
  BRIEF_V2_EDIT: 'Edit',
  BRIEF_V2_SHARE: 'Share',
  SHARE_THIS_BRIEF: 'Share this brief',
  SHARED_BRIEF_NOT_FOUND: 'Brief not found',
  SHARED_BRIEF_EXPIRED: 'This link may have expired or been deactivated.',
