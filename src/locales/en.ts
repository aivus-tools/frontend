export const EN_LOCALES = {
  ...
  BRIEF_LIST_VERSION: 'Version',
  BRIEF_LIST_OFFERS: 'Offers',
  BRIEF_LIST_SHARE_STATUS: 'Share',
  BRIEF_LIST_VIEWS: 'views',
  BRIEF_LIST_NOT_SHARED: 'not shared',
  BRIEF_LIST_SHARE_INACTIVE: 'inactive',
  BRIEF_LIST_SHARED: 'shared',
  BRIEF_LIST_OFFER_RECEIVED: 'offer',
  BRIEF_LIST_COMPARE_N_OFFERS: (count: string) => `Compare ${count} offers`,
  BRIEF_RENAME: 'Rename',
  BRIEF_DUPLICATE: 'Duplicate',
  BRIEF_DELETE: 'Delete',
  ...
  BRIEF_DUPLICATE_SUCCESS: 'Brief duplicated',
  ...
  BRIEF_V2_HERO_TITLE: 'Your brief is ready!',
  BRIEF_V2_HERO_SUBTITLE: 'Share it with vendors to start receiving offers.',
  BRIEF_V2_HERO_SHARE_CTA: 'Share with vendors',
  BRIEF_V2_HERO_VIEWS_TITLE: (count: string) => `${count} vendors viewed your brief`,
  BRIEF_V2_HERO_VIEWS_SUBTITLE: 'Keep iterating, or copy the link again to share with more.',
  BRIEF_V2_HERO_COPY_CTA: 'Copy share link',
  BRIEF_V2_PREVIEW_AS_VENDOR: 'Preview as vendor',
  BRIEF_V2_PREVIEW_TITLE: 'Vendor preview',
  BRIEF_V2_PREVIEW_DRAFT_NOTE: 'Preview based on current draft. Will be frozen at the moment of sharing.',
  BRIEF_V2_AI_COST_TOOLTIP: 'Total AI cost for this brief (admin only)',
