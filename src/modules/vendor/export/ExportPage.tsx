...
const CoverPage = dynamic(() => import('./CoverPage').then((x) => ({ default: x.CoverPage })), { ssr: false });
const AssumptionsPage = dynamic(() => import('./AssumptionsPage').then((x) => ({ default: x.AssumptionsPage })), {
  ssr: false,
});
...
export const ExportPage = (props: ExportPageProps) => {
