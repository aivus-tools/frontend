...
export const SettingsItemClient = ({ className, ...props }: SettingsItemClientProps) => {
	return (
		<div className={cn(styles.client, className)} {...props}>
			<div className={cn(styles.column)}>
				<div className={cn(styles.section)}>
					<Text className={cn(styles.item)} color='grayLight' size='l' weight='regular'>
						Surcharge
					</Text>
					<Text className={cn(styles.item)} color='grayDark' size='l' weight='regular'>
						20%
					</Text>
				</div>
				<div className={cn(styles.section)}>
